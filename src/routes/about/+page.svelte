...
<div class="mx-auto max-w-2xl px-4 py-8">
    ...
    <div class="flex flex-col gap-8 md:flex-row">
        ...
        <div class="flex w-full justify-center md:w-1/3 md:justify-start">
            <Avatar src="$lib/assets/images/jamie-strausbaugh.png" alt="Jamie Strausbaugh" />
        </div>
        ...
        <div class="w-full md:w-2/3">
            ...
            <div class="mt-6 flex items-center gap-1">
                <a
                    href="https://www.linkedin.com/in/jamiestrausbaugh"
                    target="_blank"
                ...
                <a
                    href="https://github.com/Jamoverjelly"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <a
                    href="https://bsky.app/profile/jstrausb.bsky.social"
                    target="_blank"
                    rel="noopener noreferrer"
